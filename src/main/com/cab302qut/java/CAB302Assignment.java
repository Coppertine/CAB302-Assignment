...
public class CAB302Assignment extends Application {
    ...
    private static final String configFile = "E:\\Uni 2021\\CAB302\\src\\main\\resources\\defaultconfig.ini";//  String.valueOf(CAB302Assignment.getClassLoader().getResource("defaultconfig.ini"));
